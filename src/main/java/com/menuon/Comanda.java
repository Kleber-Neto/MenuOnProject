...
public class Comanda {
    ...
    private List<ItemComanda> pedidos = new ArrayList<>();

    // @OneToMany(mappedBy = "comanda", cascade = CascadeType.ALL, orphanRemoval =
    // true)
    // private List<ItemComanda> pedidos;

    // @OneToMany(mappedBy = "comanda", cascade = CascadeType.ALL, fetch =
    // FetchType.EAGER)
    // private List<ItemComanda> pedidos;
